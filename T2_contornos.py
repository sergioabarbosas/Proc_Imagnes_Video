...
# ===================================================================
# Trabajo en grupo: Christian Forero - Sergio Barbosa
# -------------------------------------------------------------------
# python T2_Contornos.py <path_to_image> <image_name>
# C:\Users\FAMILIAR\Desktop\sbarbosa\Universidad_Javeriana\Proc_imagenes_video\Images placa5.png
...
if __name__ == '__main__':
    ...
    # mask
    ret, Ibw_sat = cv2.threshold(image_hsv[..., 1], 100, 255, cv2.THRESH_BINARY)
    ...
    cnts, hierarchy = cv2.findContours(mask_dilated, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
    color = (255, 255, 0)
    ...
    for c in cnts:
        ...
        box = np.int0(box)
        cv2.drawContours(image_draw, [box], 0, (0, 191, 255), 2)
        print("Angle: ",90-rect[2])
    ...
    #cv2.imshow("Image", image_draw_fill)
    cv2.waitKey(0)
